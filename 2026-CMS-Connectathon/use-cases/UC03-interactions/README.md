...
Clinician-readable writeups for UC03 (Pediatric Periodontitis / Type 1 Diabetes), following the same 5-interaction pattern established for UC01 and UC02. These writeups live in this subfolder alongside the flat use case document (`use-cases/UC03-Pediatric-Referral.md`) rather than restructuring it; both share the same corrected Connecticut ecosystem model (Connie hub, BeneCare ASO, Gainwell fiscal agent, CTDHP dental plan, DSS sponsor — no MCO).
